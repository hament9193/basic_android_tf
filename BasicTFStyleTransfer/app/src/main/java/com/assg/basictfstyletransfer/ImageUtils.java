...
//  private privatestatic final Logger LOGGER = new Logger();

  static {
    try {
      System.loadLibrary("assg_basictfstyletransfer");
...
//      LOGGER.w("Native library not found, native RGB -> YUV conversion may be unavailable.");
  ...
  public static boolean saveBitmap(final Bitmap bitmap, final String filename) {
    final String root =
        Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "BasicTFStyleTransfer";
